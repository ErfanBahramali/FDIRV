...
# chmod +x /home/user/Desktop/FDIRV/socks2vpn-proxy.sh

# Add alias in:
# ~/.bashrc or ~/.zshrc
# # FDIRV
# alias vpn-proxy="sudo /home/user/Desktop/FDIRV/socks2vpn-proxy.sh"

# Password-free and safe this file in:
# /etc/sudoers
# sudo visudo
# #FDIRV
# user ALL=(ALL) NOPASSWD: /home/user/Desktop/FDIRV/socks2vpn-proxy.sh

# Usage:
# sudo ./socks2vpn-proxy.sh "127.0.0.1:10808"
# Or with alias:
# vpn-proxy
# vpn-proxy "127.0.0.1:10808"
...
# ProxyChains proxy (can override with argument, default from config.sh)
PROXYCHAINS_PROXY="${1:-$PROXYCHAINS_PROXY}"
